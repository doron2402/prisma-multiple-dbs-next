...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/doron2402/github/my-multi-client-app/prisma-post-database/post-database-client-types",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/Users/doron2402/github/my-multi-client-app/prisma-post-database/schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
...
config.injectableEdgeEnv = () => ({
  parsed: {
    POSTS_DATABASE_URL: typeof globalThis !== 'undefined' && globalThis['POSTS_DATABASE_URL'] || typeof process !== 'undefined' && process.env && process.env.POSTS_DATABASE_URL || undefined
  }
})
